...
{    
    ...
    if (correct_rate < correct_rate_thres || ghost_rate > ghost_rate_thres)
    {
        ...
        std::cout << "correct_rate < " << correct_rate_thres << "%" << std::endl;
        std::cout << "ghost_rate > " << ghost_rate_thres << "%" << std::endl;
        return false;
    }
    ...
    for (int i = 0; i < n_correct; i ++)
    {
        ...
        error = myMATH::distance(pt3d_sol, tr3d_list[tr_id]._pt_center);
